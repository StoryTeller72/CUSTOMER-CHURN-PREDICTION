...
**Числовые признаки**: tenure, TotalCharges, MonthlyCharges

**Категориальные**: gender, Partner, Dependents, PhoneService, MultipleLines, InternetService, OnlineSecurity, OnlineBackup, DeviceProtection, TechSupport, StreamingTV, StreamingMovies, Contract,PaperlessBilling, PaymentMethod, SeniorCitizen

Более подробное описание признаков можно найти в data/columnsDescription.md
...
|RandomForest | 0.634 | 0.845 | 0.527 | 0.794|
| LGBM | 0.630 | 0.841 | 0.534 | 0.766|
| XGBM | 0.588 | 0.845 | 0.654 | 0.535|
| CatBoost | 0.636 | 0.842 | 0.580 | 0.706|
...
- не пользуются автоматическим пополнением счета
